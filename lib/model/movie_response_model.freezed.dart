...
/// @nodoc
abstract class _$$_MovieResponseModelCopyWith<$Res>
    implements $MovieResponseModelCopyWith<$Res> {
  factory _$$_MovieResponseModelCopyWith(_$_MovieResponseModel value,
          $Res Function(_$_MovieResponseModel) then) =
      __$$_MovieResponseModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int page,
...
/// @nodoc
class __$$_MovieResponseModelCopyWithImpl<$Res>
    extends _$MovieResponseModelCopyWithImpl<$Res, _$_MovieResponseModel>
    implements _$$_MovieResponseModelCopyWith<$Res> {
  __$$_MovieResponseModelCopyWithImpl(
      _$_MovieResponseModel _value, $Res Function(_$_MovieResponseModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_MovieResponseModel(
      page: null == page
          ? _value.page
          : page // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$_MovieResponseModel implements _MovieResponseModel {
  ...
  factory _$_MovieResponseModel.fromJson(Map<String, dynamic> json) =>
      _$$_MovieResponseModelFromJson(json);
  ...
  @override
  String toString() {
    return 'MovieResponseModel(page: $page, results: $results, totalResults: $totalResults, totalPages: $totalPages, errors: $errors)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_MovieResponseModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_MovieResponseModelCopyWith<_$_MovieResponseModel> get copyWith =>
      __$$_MovieResponseModelCopyWithImpl<_$_MovieResponseModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_MovieResponseModelToJson(
      this,
    );
  }
}
...
abstract class _MovieResponseModel implements MovieResponseModel {
  factory _MovieResponseModel(
      ...
      final List<String> errors}) = _$_MovieResponseModel;
